package com.hzx.leetcode.algorithm.排序算法;

import com.hzx.leetcode.util.data.RandomNumGenerator;
...
import static com.hzx.leetcode.algorithm.排序算法.MergeSort.MergeSort;
import static com.hzx.leetcode.algorithm.排序算法.不常见.BucketFlashSort.BucketFlashSort;
import static com.hzx.leetcode.algorithm.排序算法.不常见.BucketSort.BucketSort;
import static com.hzx.leetcode.algorithm.排序算法.不常见.PigeonholeSort.PigeonholeSort;
import static com.hzx.leetcode.algorithm.排序算法.不常见.RadixSort.RadixSort_optimized;
import static com.hzx.leetcode.algorithm.排序算法.不常见.TimSort.TimSort;
...
//        futures.add(testSortAlgorithm("插入排序", () -> InsertSort_optimized(Arrays.copyOf(nums, nums.length))));
        ...
        futures.add(testSortAlgorithm("堆排序", () -> HeapSort.HeapSort(Arrays.copyOf(nums, nums.length))));
        futures.add(testSortAlgorithm("闪电桶排序", () -> BucketFlashSort(Arrays.copyOf(nums, nums.length))));
        futures.add(testSortAlgorithm("归并排序", () -> MergeSort.MergeSort(Arrays.copyOf(nums, nums.length))));
        futures.add(testSortAlgorithm("Tim排序", () -> TimSort(Arrays.copyOf(nums, nums.length))));
        futures.add(testSortAlgorithm("快速排序", () -> QuickSort.QuickSort_optimized(Arrays.copyOf(nums, nums.length))));
